...
double
uni_sardf_1(const double xt, const double yt, const double R,
             const double alpha){       
  double d=0;
  double lim2;
  double g,g2,gt;
...
double
uni_sardf_2(double xt, double yt, double R1,
             double R2){        
  double d=0;
  double lim, lim2;
  double aa,b,c,Ds;
...
double
uni_sardf_and_gradient_1(const double xt, const double yt,
...
double
uni_sardf_and_gradient_2(const double xt, const double yt,
...
double 
int_sardf_1 (double xt, double yt,
...
double 
int_sardf_2 (double xt, double yt,
              double R1, double R2)
{
  double d=0;
...
double 
int_sardf_and_gradient_1 (const double xt, const double yt,
                           const double R, const double alpha,
                           const double gxt[3], const double gyt[3],
                           double grad[3])
{
...
double 
int_sardf_and_gradient_2 (const double xt, const double yt,
                           const double R1, const double R2,
